...
# ============================================================
# 2. EMBEDDING GENERATION (NAME ONLY)
# ============================================================
def get_embeddings(tag_list):
    print(f"Generating embeddings for {len(tag_list)} tags (USING NAME ONLY)...")
    embeddings = []
    for t in tag_list:
        # CONTEXT: Using ONLY the tag name
        text = t['tag'] 
        try:
